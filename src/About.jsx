...
const Paragraph = (props) => {
    ...
    return (
        <Typography variant="body1" align="center" className={classes.paragraph}>
            {text} <a href={href} target={target} className={classes.link}>{linkText}</a>
        </Typography>
    );
};
    ...
    return (
        ...
        >
            <DialogTitle id="alert-dialog-title" disableTypography className={classes.title}>
                <Typography align="center" variant="h6">JaSON</Typography>
                <Typography align="center" variant="body2">v5.0.0</Typography>
            </DialogTitle>
            <DialogContent>
