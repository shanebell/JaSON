                ...
                {history.map((historyItem) => (
                    <div key={historyItem.id}>
                        <ListItem dense button alignItems="flex-start" onClick={() => onHistorySelect(historyItem.id)}>
                            {false && <ListItemAvatar className={classes.listItemAvatar}>
                                ...
                                <ListItemText
                                    ...
                                    secondary={
                                        <React.Fragment>
                                            ...
                                            {false && <Typography component="span" variant="body2" className={classes.method}>
                                                {historyItem.method}
                                            </Typography>}
                                            <Typography component="span" variant="caption" className={classes.trim}>
                                                {historyItem.date}
                                            </Typography>
                                        </React.Fragment>
                                    }
